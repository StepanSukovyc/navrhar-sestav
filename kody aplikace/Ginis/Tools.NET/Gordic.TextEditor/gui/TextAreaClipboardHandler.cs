...
namespace Gordic.TextEditor
{
    public class TextAreaClipboardHandler
	{
		...
		{
//			((DefaultDesktop)SimpleDesktop.Desktop).UpdateToolbars();
		}
		...
		{
			new Gordic.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new Gordic.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
