...
namespace Gordic.TextEditor.Gui.CompletionWindow
{
	...
	public class CodeCompletionListView : System.Windows.Forms.UserControl
	{
        ...
        public int Count { get { return completionData.Length; } }

        public int SelectedIndex { get { return selectedItem; } }
...
//			SetStyle(ControlStyles.DoubleBuffer, false);
		...
		public void ClearSelection()
		{
            ...
            completionData[selectedItem].IsUnique = false;
			selectedItem = -1;
        ...
        /// <summary>
        /// nalezení položky, začínající uvedeným řetězcem
        /// </summary>
        /// <param name="startText">řetězec, shoda kterého se hledá</param>
        public void SelectItemWithStart(string startText)
        {
            ...
            for (int i = 0; i < completionData.Length; ++i)
            {
                ...
                if (lowerText.StartsWith(startText))
                {
                    ...
                    if (bestQuality < quality)
                        useThisItem = true;
                    else if (bestIndex == selectedItem)
                        useThisItem = false;
            ...
            {
                completionData[bestIndex].IsUnique = isUnique;
