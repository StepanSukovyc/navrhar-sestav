...
namespace Gordic.TextEditor
{
    ...
    /// </summary>
    [ToolboxBitmap("Gordic.TextEditor.Resources.TextEditorControl.bmp")]
	[ToolboxItem(true)]
	public class TextEditorControl : TextEditorControlBase
	{
		...
		/// <summary>
		/// nastavení aktivní obalsti
		/// </summary>
		/// <param name="value">ovladač</param>
		protected void SetActiveTextAreaControl(TextAreaControl value)
		{
            SearchReplaceUtilities.TextEditorControl = this;
