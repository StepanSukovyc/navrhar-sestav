...
{
    /// <summary>
    /// výchozí strategie zvýrazňování slov
    /// </summary>
	public class DefaultHighlightingStrategy : IHighlightingStrategyUsingRuleSets
	{
        ...
        /// <summary>
        /// seznam pravidel zvýraznění
        /// </summary>
        public List<HighlightRuleSet> Rules { get { return rules; } }

        string[] extensions;
        /// <summary>
        /// povolené koncovky dané strategie
        /// </summary>
        ...
        /// <summary>
        /// dostupné předem definované barvy
        /// </summary>
        public IEnumerable<KeyValuePair<string, HighlightColor>> EnvironmentColors { get { return environmentColors; } }

        HighlightColor defaultTextColor;
        /// <summary>
        /// výchozí barva textu
        /// </summary>
        public HighlightColor DefaultTextColor { get { return defaultTextColor; } }

        /// <summary>
        /// import nastavení 
        /// </summary>
        /// <param name="source">zdroj nastavení</param>
        ...
        /// konstruktor třídy
        /// </summary>
        /// <param name="name">Název strategie</param>
        ...
        /// <summary>
        /// nalezení množiny pravidel zvýraznění dle názvu
        /// </summary>
        /// <param name="name">název hledané množiny</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// přidání pravidla do množiny
        /// </summary>
        /// <param name="aRuleSet">přidávaná množina pravidel zvýraznění</param>
        ...
        public HighlightRuleSet GetRuleSet(Span aSpan)
        {
            if (aSpan == null)
                ...
                if (aSpan.RuleSet != null)
                    return aSpan.RuleSet.Reference != null
                        ? aSpan.RuleSet.Highlighter.GetRuleSet(null)
                        : aSpan.RuleSet;
                else
                    return null;
        }
