...
namespace Gordic.TextEditor.SearchAndReplace
{
	...
	public static class SearchOptions
	{
		...
		static string findPattern    = string.Empty;
		static string replacePattern = string.Empty;
		...
		public static string FindPattern {
			...
			set {
                if (value != FindPattern || !FindPatterns.Contains(value))
                {
                    findPattern = value;
                    List<string> oldPatterns = new List<string>(FindPatterns);
                    if (!oldPatterns.Contains(value))
                    {
                        oldPatterns.Insert(0, value);
                        FindPatterns = new List<string>(oldPatterns);
                    }
                }
			}
		}
        ...
        public static List<string> FindPatterns
        {
            get
            {
                ...
                return new List<string>(properties.Get("FindPatterns", "").Split('\xFF'));
            }
            set
            {
                properties.Set("FindPatterns", String.Join("\xFF", value.ToArray()));
            }
        }
		...
		public static string ReplacePattern {
            ...
            set
            {
                if (value != ReplacePattern || !ReplacePatterns.Contains(value))
                {
                    replacePattern = value;
                    List<string> oldPatterns = new List<string>(ReplacePatterns);
                    if (!oldPatterns.Contains(value))
                    {
                        oldPatterns.Insert(0, value);
                        ReplacePatterns = new List<string>(oldPatterns);
                    }
                }
            }
		}

        public static List<string> ReplacePatterns
        {
            get
            {
                ...
                return new List<string>(properties.Get("ReplacePatterns", "").Split('\xFF'));
            }
            set
            {
                properties.Set("ReplacePatterns", String.Join("\xFF", value.ToArray()));
            }
        }
