(function ($) {
    "use strict";
    namespace("Gordic.Ssl.WebClient.Details.Spis", {
        flashTimer: 5000,
        ...
        onDetailBuilderInit: function (builder) {
            ...
            builder.moveComponentBefore("SslDetailSbernyArch", "SslProfilSpis");
            builder.moveComponentAfter("WflRedistribuce", "SslProfilSpis");
            builder.moveComponentAfter("WflPrilohy", "SslProfilSpis");
