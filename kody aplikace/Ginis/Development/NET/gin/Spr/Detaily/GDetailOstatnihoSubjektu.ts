namespace Gordic.Spr.WebApp {
     ...
     */
    @gcontent
    export class GDetailOstatnihoSubjektu extends GDetailBuilderContent<UsedComponentsNew> implements IGContent {
        IxpSpis: string;
        IxsEsu: string;
        TypVazby: number;
        LicZast: string;
        ...
        onDetailBuilderInit(builder: Gordic.Gin.DetailBuilder.GDetailBuilder): void {
            ...
            builder.withComponent<this>("ostatniSubjektDetail", {
                tabs:
                {
                    tabZakladni:
                    {
        ...
        createForm(): Gordic.Forms.Form {
            ...
            var form = new Gordic.Forms.Form({ tabLabel: "jres:25200183", opened: true }) //RC 25200183 : Detail ostatního subjektu
                ...
                .addField("gselectbox", "w-6", Gordic.Prefabs.Select.wflsdvaSprDto(), {
                    ...
                    serverFilters: { typ_vazby: [Gordic.Spr.Interface.TypSubjektuEnum.Ostatni] }
                })
                .addRow()
