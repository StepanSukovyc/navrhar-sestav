declare namespace Gordic.Prr.UIWebClient {
    class GDetailFormularDeniku extends GDetailBuilderContent<Gordic.Gin.WebClient.RegSpa.GBaseDetailComponentExtensions & ThisType<GContent<Gordic.Gin.WebClient.RegSpa.GBaseDetailComponentExtensions>>> implements IGContent {
        IxsRad?: string;
