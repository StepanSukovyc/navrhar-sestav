...
namespace Gordic.Prr.UIWebClient {
    ...
    @gcontent
    export class GSeznamDeniku extends GContentBase {
        ...
        openDetail(rezim: Gordic.Gin.Interface.RegSpa.GRezimContentu): void {
            ...
            var height = 500;
            var modal = true;
            var gridRc: Gordic.Components.GridRC<Gordic.Prr.Interface.GPrrDenikDto> | undefined = undefined;

            if (rezim == Gordic.Gin.Interface.RegSpa.GRezimContentu.View) {
                var selection: Gordic.Prr.Interface.GPrrDenikDto[];
        ...
        public createGridFormat(): Gordic.Data.GridFormat<Gordic.Prr.Interface.GPrrDenikDto> {
            return new Gordic.Data.GridFormat<Gordic.Prr.Interface.GPrrDenikDto>()
                .addTextColumn({
                    name: "nazev",
