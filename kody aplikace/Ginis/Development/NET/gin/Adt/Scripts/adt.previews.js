    ...
    Gordic.Previews.register("adt:RegistrRevizi", {
        ...
        render: function (div, dto) {
            ...
            var formBuilder =  new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
                ...
                .addRow("jres:33115361").addField("gstaticfield", { //RC 33115361 : Typ revize
                    name: "typ_revize",
                    //itemTemplate: (obj) => {
                    //    switch (obj) {
                    //        case "0":
                ...
                .addRow("Stav fáze").addField("gstaticfield", { name: "stav_faze_txt"})
                .addRow("jres:33115503").addField("gstaticfield", { name: "faze_nazev" }) //RC 33115503 : Název fáze
            if (dto.stav_revize == 90) {    
                formBuilder
                    ...
                    .addField("gstatic", {
                        ...
                        customClass: "g-state-text g-state-error bold",
                    ...
                    //        if (obj == 90) {
                    //            return "<i class='fa fa-check-circle g-state-text g-state-success' aria-hidden='true'></i>" + "jres:33115364";  //RC 33115364 : Zakázaná
                    ...
                    //        }
                    //    },
                    //    customClass: "w-6 g-state-text g-state-error"
                    //}) //RC 33115229 : Stav
            }
                ...
                formBuilder
                    ...
                    .addField("gstatic", {
                        ...
                        customClass: "g-state-text g-state-success bold",
                        caption: "Doporučená"
                    }) //RC 33115229 : Stav
                    //.addField("gstaticfield", {
                    //    name: "stav_revize",
                    ...
                    //    itemTemplate: function (obj) {
                    //        if (obj == 0) {
                    //            return "<i class='fa fa-check-circle g-state-text g-state-success' aria-hidden='true'></i> " + " Doporučená";  //RC 33115364 : Zakázaná
                    //            //return "<font color='red'>jres:33115364</font>"; //RC 33115364 : Zakázaná
                    //        }
                    //        else {
                    //            return obj;
                    //        }
                    //    },
                    //    customClass: "w-6 g-state-text g-state-success"
                    //}) //RC 33115229 : Stav
            }
            else if (dto.stav_revize == 10) {
                formBuilder
                    .addRow("jres:33115229")
                    .addField("gstatic", {
                        name: "stav_stat",
                        icon: "fa-exclamation-circle g-state-text g-state-warning",
                        customClass: "g-state-text g-state-warning bold",
                        caption: "Betatest"
                    }) //RC 33115229 : Stav
                    //.addField("gstaticfield", {
                    //    name: "stav_revize",
                    ...
                    //    itemTemplate: function (obj) {
                    //        if (obj == 10) {
                    //            return "Betatest";  //RC 33115364 : Zakázaná
                    //            //return "<font color='red'>jres:33115364</font>"; //RC 33115364 : Zakázaná
                    //        }
                    //        else {
                    //            return obj;
                ...
                formBuilder
                    ...
                    //    itemTemplate: function (obj) {
                    //        if (obj == 20) {
                    //            return "Alfatest";  //RC 33115364 : Zakázaná
                    //            //return "<font color='red'>jres:33115364</font>"; //RC 33115364 : Zakázaná
                    //        }
                    //        else {
                    //            return obj;
            ...
            else if (dto.stav_revize == 30) {
                formBuilder
                    .addRow("jres:33115229")
                    .addField("gstatic", {
                        name: "stav_stat",
                        icon: "fa-info-circle g-state-text g-state-info",
                        customClass: "g-state-text g-state-info bold",
                        caption: "Ve výrobě"
                    }) //RC 33115229 : Stav
                    //.addField("gstaticfield", {
                    //    name: "stav_revize",
                    ...
                    //    itemTemplate: function (obj) {
                    //        if (obj == 30) {
                    //            return "Ve výrobě";  //RC 33115364 : Zakázaná
                    //            //return "<font color='red'>jres:33115364</font>"; //RC 33115364 : Zakázaná
                    //        }
                    //        else {
                    //            return obj;
                    //        }
                    //    },
                    //    customClass: "w-6 g-state-text g-state-info"
                    //}) //RC 33115229 : Stav
            }
            else if (dto.stav_revize == 40) {
                formBuilder
                    .addRow("jres:33115229")
                    .addField("gstatic", {
                        name: "stav_stat",
                    ...
                    //    itemTemplate: function (obj) {
                    //        if (obj == 40) {
                    //            return "Odmítnutá";  //RC 33115364 : Zakázaná
                    //            //return "<font color='red'>jres:33115364</font>"; //RC 33115364 : Zakázaná
                    //        }
                    //        else {
                    //            return obj;
                ...
                formBuilder
                    ...
                    .addField("gstatic", {
                        ...
                        customClass: "g-state-text g-state-important bold",
            ...
            formBuilder
                .addRow("Zveřejněno").addField("gstaticfield", { name: "dat_mpd", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold",  }) //RC 33115442 : Poslední změna
            if (dto.dat_zmena != undefined) {
                formBuilder
                    .addRow("jres:33115442").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115442 : Poslední změna
            }
            else {
                formBuilder
            ...
            if (dto.dat_revoke != undefined) {
                formBuilder
                    .addRow("jres:33115231").addField("gstaticfield", { name: "dat_revoke", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115231 : Zakázáno
            }
            else {
                formBuilder
            ...
            if (dto.dat_vymaz != undefined) {
                formBuilder
                    .addRow("jres:33115232").addField("gstaticfield", { name: "dat_vymaz", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115232 : Smazáno
            }
            else {
                formBuilder
            ...
            if (dto.dat_nedoporuc != undefined) {
                formBuilder
                    .addRow("jres:33115504").addField("gstaticfield", { name: "dat_nedoporuc", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115504 : Nedoporučeno
            }
            else {
                formBuilder
                    .addRow("jres:33115504").addField("gstaticfield", { name: "dat_nedoporuc",  /*valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold"*/ }) //RC 33115504 : Nedoporučeno
            }
            formBuilder
                ...
                .addRow("jres:33115405").addField("gstaticfield", {
                    name: "min_poz_verze_db", itemTemplate: function (obj) {
                        return obj + " ," + dto.min_poz_verze_db2;
                    }
                })//.addField("gstaticfield", { name: "delimiter", customClass: "w-2", initialValue:"," }).addField("gstaticfield", { name: "min_poz_verze_db2",  customClass: "w-4" }) //RC 33115405 : Minimální požadovaná verze DB
                .addRow("jres:33115367").addField("gstaticfield", { name: "nazev_souboru" }) //RC 33115367 : Název souboru
                .addRow("jres:33115481").addField("gstaticfield", { //RC 33115481 : Velikost souboru
                    name: "velikost",
                    itemTemplate: function (obj) {
                        let stringRetVal = "";
                        if (obj) {
                ...
                .addRow("Email pro avizace k revizi").addField("gstaticfield", { name: "mail" })
            if (dto.dat_requested != undefined) {
                formBuilder
                    .addRow("jres:33115498").addField("gstaticfield", { name: "dat_requested", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" })  //RC 33115498 : Požadavek k vytvoření
            }
            else {
                formBuilder
                    .addRow("jres:33115498").addField("gstaticfield", { name: "dat_requested" }) //RC 33115498 : Požadavek k vytvoření
            }
            if (dto.dat_created != undefined) {
                formBuilder
                    .addRow("jres:33115499").addField("gstaticfield", { name: "dat_created", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115499 : Vznik revize
            }
            else {
                formBuilder
                    .addRow("jres:33115499").addField("gstaticfield", { name: "dat_created" })  //RC 33115499 : Vznik revize
            }
            formBuilder
                //.addRow("Požadavek k vytvoření").addField("gstaticfield", { name: "dat_requested" })
                //.addRow("Vznik revize").addField("gstaticfield", { name: "dat_created" })   xxx
                .addRow("Větev").addField("gstaticfield", { name: "branch" })
                .addRow("Build").addField("gstaticfield", { name: "build" })
                .addRow("SVN").addField("gstaticfield", { name: "svn" })
                .addRow("Kotva").addField("gstaticfield", { name: "kotva" })
                .addRow("Autor zadání revize do výroby").addField("gstaticfield", { name: "autor" })
                .addRow("Lokalizace").addField("gstaticfield", {
                    name: "priz_loc", itemTemplate: function (obj) {
                        if (obj == 1) {
                            return "Ano";
                        }
                        else {
            ...
            //if (dto.stav_faze_visible == 1) {
                if (form.find("div")[39].innerText == 'Neurčeno') {
                    form.find("div")[39].style.color = '#FFD700'
                    form.find("div")[39].style.fontWeight = 'bold'
                }
                else if (form.find("div")[39].innerText == 'Ukončená') {
                    form.find("div")[39].style.color = '#808080'
                    form.find("div")[39].style.fontWeight = 'normal'
                }
                else if (form.find("div")[39].innerText == 'Neperspektivní') {
                    form.find("div")[39].style.color = '#C63C3C'
                    form.find("div")[39].style.fontWeight = 'bold'
                }
                else if (form.find("div")[39].innerText == 'Dočasná') {
                    form.find("div")[39].style.color = 'saddlebrown'
                    form.find("div")[39].style.fontWeight = 'normal'
                }
                else if (form.find("div")[39].innerText == 'Vývoj') {
                    form.find("div")[39].style.color = '#6699FF'
                    form.find("div")[39].style.fontWeight = 'normal'
                }
                else if (form.find("div")[39].innerText == 'K testování') {
                    form.find("div")[39].style.color = '#2650B9'
                    form.find("div")[39].style.fontWeight = 'bold'
                }
                else if (form.find("div")[39].innerText == 'Nová') {
                    form.find("div")[39].style.color = '#27B779'
                    form.find("div")[39].style.fontWeight = 'bold'
                }
                else if (form.find("div")[39].innerText == 'Perspektivní') {
                    form.find("div")[39].style.color = 'black'
                    form.find("div")[39].style.fontWeight = 'bold'
                }
                //form.find("div")[39].style.marginLeft = '5px'
                //form.find("div")[39].style.marginTop = '9px'
                //form.find("div")[39].style.width = 'fit-content'
            //}
...
Gordic.Previews.register("adt:ReinstalacniBaliky", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            .addSection()
            .addRow("jres:33115117").addField("gstaticfield", { //RC 33115117 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    switch (obj) {
                        case 100:
            ...
            .addRow("jres:33115133").addField("gstaticfield", { name: "dat_zmena", valueType: "datetime", itemTemplate: "{#:datetime}", hideZeroTime: false, customClass: "font-weight: bold" })  //RC 33115133 : Datum poslední změny
        if (dto.autor_review != undefined) {
            formBuilder
                .addRow("Code review provedl").addField("gstaticfield", { name: "autor_review",  customClass: "font-weight: bold" }) //RC 33115399 : Poslední export do KOF
        }
        else {
            formBuilder
                .addRow("Code review provedl").addField("gstaticfield", { name: "autor_review" }) //RC 33115399 : Poslední export do KOF
        }
        if (dto.dat_zmena_review != undefined) {
            formBuilder
                .addRow("Datum code review").addField("gstaticfield", { name: "dat_zmena_review", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115399 : Poslední export do KOF
        }
        else {
            formBuilder
                .addRow("Datum code review").addField("gstaticfield", { name: "dat_zmena_review" }) //RC 33115399 : Poslední export do KOF
        }
        formBuilder
            ...
            .addRow("jres:33115136").addField("gstaticfield", { //RC 33115136 : Typ balíku
                name: "typ_gdt",
                itemTemplate: function (obj) {
                    switch (obj) {
                        case 0:
            ...
            .addRow("jres:33115137").addField("gstaticfield", { //RC 33115137 : Priorita
                name: "priorita_gdt",
                itemTemplate: function (obj) {
                    switch (obj) {
                        case 0:
...
Gordic.Previews.register("adt:ChybyReinstalaci", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115325").addField("gstaticfield", { name: "dat_start", valueType: "datetime", itemTemplate: "{#:datetime}",  hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115325 : Čas spuštění GDZ balíku
            ...
            .addRow("jres:33115328").addField("gstaticfield", { name: "dat_exs", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115328 : Datum expirace
            .addRow("jres:33115330").addField("gstaticfield", { name: "dat_mpd", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115330 : Čas zápisu
            .addRow("jres:33115343").addField("gstaticfield", { name: "dat_zprac", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115343 : Čas zpracování
            .addRow("jres:33115332").addField("gstaticfield", { name: "mail_response" }) //RC 33115332 : Mail
            .addRow("jres:33115333").addField("gstaticfield", { //RC 33115333 : Stav kontroly ADL
                name: "stav_kontr_adl",
                itemTemplate: function (obj) {
                    if (obj == 0) {
            ...
            .addRow("jres:33115338").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: false, customClass: "font-weight: bold" }) //RC 33115338 : Změněno
    ...
    //Preview pro ulohu Reinstalacni baliky
    Gordic.Previews.register("adt:VyvojoveDatabaze", {
        canRender: function (dto) { return true; },
        render: function (div, dto) {
            var currentElement = $(div);
            ...
            //data jsou ready -> samotné vytvoření náhledu
            //currentElement.empty().append("<h2 class='g-state-text g-state-active' style='margin: 0.5rem;'>Licence '" + dto.nazev + "'</h2><hr style='margin: 0.5rem; opacity: 0.2;'/>");
            currentElement.empty().append("<h2 class='g-state-text g-state-active' style='margin: 0.5rem;'>" + "jres:33115508" + "</h2><hr style='margin: 0.5rem; opacity: 0.2;'/>"); //RC 33115508 : Vývojová databáze
            ...
            var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
                ...
                //.addRow("ID Databáze").addField("gstaticfield", { name: "id_databaze" })
                //.addRow("ID Serveru").addField("gstaticfield", { name: "id_server" })
                .addRow("Typ_databáze").addField("gstaticfield", { name: "typ_db" }) 
                .addRow("Azure").addField("gstaticfield", {
                    name: "priz_azure", itemTemplate: function (obj) {
                        switch (obj) {
                            case 0:
                                return "Ne"; //RC 33115020 : Aktivní
                                break;
                            case 1:
                                return "Ano"; //RC 33115021 : Připraven
                                break;
                            default:
                                return "jres:33115022"; //RC 33115022 : Chybná aktivita
                        }
                ...
                .addRow("Server").addField("gstaticfield", { name: "server_name" }) 
                .addRow("Databáze").addField("gstaticfield", { name: "db_name" }) 
                .addRow("Licence").addField("gstaticfield", { name: "lic" })
                .addRow("Verze").addField("gstaticfield", { name: "verze" }) 
                .addRow("UNICODE").addField("gstaticfield", {
                    name: "priz_unicode", itemTemplate: function (obj) {
                        switch (obj) {
                            case 0:
                                return "Ne"; //RC 33115020 : Aktivní
                                break;
                ...
                .addRow("Popis").addField("gstaticfield", { name: "popis" }) 
                .addRow("Poznámka k databázi").addField("gstaticfield", { name: "poznamka_databaze" }) 
                .addRow("Data_source").addField("gstaticfield", { name: "data_source" }) 
                .addRow("Edice").addField("gstaticfield", { name: "edice" }) 
                .addRow("Vas povolen").addField("gstaticfield", {
                    name: "is_vas_povolen", itemTemplate: function (obj) {
                        switch (obj) {
                            case 0:
                                return "Ne"; //RC 33115020 : Aktivní
                                break;
                ...
                .addRow("Ginis").addField("gstaticfield", {
                    name: "is_ginis", itemTemplate: function (obj) {
                        switch (obj) {
                            case 0:
                                return "Ne"; //RC 33115020 : Aktivní
                                break;
                ...
                //.addRow("Pořadí").addField("gstaticfield", { name: "poradi" }) 
                //.addRow("Err").addField("gstaticfield", { name: "err" }) 
                .addRow("Conn. str").addField("gstaticfield", { name: "conn_str" }) 
                .addRow("Poslední přihlášení").addField("gstaticfield", { name: "dat_pos_prihl", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Poslední přihlášený").addField("gstaticfield", { name: "jm_posl_prihl" }) 
                .addRow("Poslední změna struktur").addField("gstaticfield", { name: "dat_zmena_str", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Poslední změny procedur").addField("gstaticfield", { name: "dat_zmena_proc", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Datum vytvoření").addField("gstaticfield", { name: "dat_vytvoreni", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Poslední záloha").addField("gstaticfield", { name: "dat_zaloha", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                //.addRow("Datum řádek vložení").addField("gstaticfield", { name: "dat_radek_vloz", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Aktualizováno").addField("gstaticfield", { name: "dat_radek_akt", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
                .addRow("Velikost mdf").addField("gstaticfield", { name: "vel_mdf" })
                .addRow("Velikost ldf").addField("gstaticfield", { name: "vel_ldf" })
                .addRow("Příznak Read only").addField("gstaticfield", {
                    name: "priz_read_only", itemTemplate: function (obj) {
                        switch (obj) {
                            case 0:
                                return "Ne"; //RC 33115020 : Aktivní
                                break;
                ...
                .addRow("Poznámka k serveru").addField("gstaticfield", { name: "poznamka_server" }) 
                .addRow("Aktivita databáze").addField("gstaticfield", { //RC 33115117 : Aktivita
                    name: "aktivita_databaze",
                    itemTemplate: function (obj) {
                        switch (obj) {
                            case 100:
                                return "jres:33115020"; //RC 33115020 : Aktivní
                ...
                .addRow("Aktivita serveru").addField("gstaticfield", { //RC 33115117 : Aktivita
                    name: "aktivita_server",
                    itemTemplate: function (obj) {
                        switch (obj) {
                            case 100:
                                return "jres:33115020"; //RC 33115020 : Aktivní
                ...
                .addRow("Datum poslední změny").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) 
...
Gordic.Previews.register("adt:DalsiSoubory", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115511").addField("gstaticfield", { //RC 33115511 : Veřejný
                name: "priz_verejny",
                itemTemplate: (obj) => {
                    if (obj == 0) {
            ...
            .addRow("jres:33115377").addField("gstaticfield", { //RC 33115377 : Typ souboru
                name: "typ_dif",
                itemTemplate: (obj) => {
                    if (obj == 0) {
            ...
            .addRow("jres:33115162").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115162 : Poslední změna
...
Gordic.Previews.register("adt:PrehledLicenciDatabaze", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115061").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115061 : Platnost od
            .addSection()
            .addRow("jres:33115062").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115062 : Platnost do
            .addRow("jres:33115063").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", customClass: "font-weight: bold" }) //RC 33115063 : Poslední změna
            //.addRow("jres:33115149").addField("gstaticfield", { //RC 33115149 : Aktivita
            //    name: "aktivita",
            //    itemTemplate: (obj) => {
            //        if (obj == 100) {
            ...
            .addRow("jres:33115068").addField("gstaticfield", { //RC 33115068 : Typ implementace
                name: "tyi",
                itemTemplate: function (obj) { //Transformace Typ implementace
            ...
            .addRow("jres:33115070").addField("gstaticfield", { //RC 33115070 : Kultura
                name: "kultura",
                itemTemplate: function (obj) { //Kultura
                    if (obj == 0) {
            ...
            .addSection()
            .addRow("jres:33115071").addField("gstaticfield", { name: "dat_mpd", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115071 : Vznik databáze
...
Gordic.Previews.register("adt:SkupinyDatabazi", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115147").addField("gstaticfield", { //RC 33115147 : Typ skupiny databází
                name: "typ_sdb",
                itemTemplate: function (obj) {
                    if (obj == 0) {
            ...
            .addRow("jres:33115150").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115150 : Poslední změna
            .addRow("jres:33115151").addField("gstaticfield", { name: "zmenil" }) //RC 33115151 : Změnil
            .addRow("jres:33115388").addField("gstaticfield", { //RC 33115388 : Režim aktualizace revizí
                name: "rezim_aktual",
                itemTemplate: function (obj) {
                    if (obj == 0) {
                        return "jres:33115495"; //RC 33115495 : Vývojové
                    }
                    if (obj == 5) {
                        return "jres:33115496"; //RC 33115496 : Produkční
                    }
                    else if (obj == 10) {
                        return "jres:33115497"; //RC 33115497 : Stabilní
                    }
                    else if (obj == 20) {
            ...
            .addRow("jres:33115387").addField("gstaticfield", { //RC 33115387 : Režim aktualizace GDZ
            ...
            .addRow("jres:33115153").addField("gstaticfield", { //RC 33115153 : Povolení akutních GDZ
                name: "priz_akut_gdz",
                itemTemplate: function (obj) {
                    if (obj == 0) {
                        return "jres:33115081"; //RC 33115081 : Ne
...
Gordic.Previews.register("adt:PrimarniLicenceDB", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115157").addField("gstaticfield", { //RC 33115157 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115159").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115159 : Platnost od
            .addRow("jres:33115160").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115160 : Platnost do
            .addRow("jres:33115161").addField("gstaticfield", { name: "dat_mpd", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115161 : Datum vzniku
            .addRow("jres:33115162").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115162 : Poslední změna
            .addRow("jres:33115163").addField("gstaticfield", { name: "zmenil" }) //RC 33115163 : Změnil
            .addRow("jres:33115388").addField("gstaticfield", { //RC 33115388 : Režim aktualizace revizí
                name: "rezim_aktual",
...
Gordic.Previews.register("adt:LicenceRadPID", {
    ...
    render: function (div, dto) {
        ...
        formBuilder
            ...
            .addRow("jres:33115169").addField("gstaticfield", { //RC 33115169 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115171").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115171 : Platnost od
            .addRow("jres:33115172").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115172 : Platnost do
            .addRow("jres:33115173").addField("gstaticfield", { name: "dat_mpd", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115173 : Datum vzniku
            .addRow("jres:33115174").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:date}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115174 : Poslední změna
...
Gordic.Previews.register("adt:BalikyLicenci", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115180").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115180 : Platnost od
            .addRow("jres:33115181").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115181 : Platnost do
            ...
            .addRow("jres:33115183").addField("gstaticfield", { //RC 33115183 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115402").addField("gstaticfield", { //RC 33115402 : Distributor
                name: "distributor",
                itemTemplate: function (obj) {
                    if (obj == 0) {
            ...
            .addRow("jres:33115404").addField("gstaticfield", { //RC 33115404 : Obchodní model
                name: "ob_model",
                itemTemplate: function (obj) {
                    if (obj == 0) {
            ...
            .addRow("Cloud").addField("gstaticfield", { //RC 33115404 : Obchodní model
                name: "provoz_cloud_txt",
            })
            .addRow("jres:33115418").addField("gstaticfield", { //RC 33115418 : URL CRM
                name: "url_crm",
                itemTemplate: function (obj) {
                    if (obj != null) {
            ...
            .addRow("jres:33115419").addField("gstaticfield", { //RC 33115419 : URL Cloud
                name: "url_cloud",
                itemTemplate: function (obj) {
                    if (obj != null) {
                        return "<a href='https://" + obj + "/' target='_blank'>  " + obj + "</a> ";
        ...
        if (dto.dat_plat_cloud_od != undefined) {
            formBuilder
                .addRow("Platba cloud od").addField("gstaticfield", { name: "dat_plat_cloud_od", /*valueType: "datetime", hideZeroTime: true,*/ customClass: "font-weight: bold" }) //RC 33115399 : Poslední export do KOF
        }
        else {
            formBuilder
        ...
        if (dto.dat_plat_lic_od != undefined) {
            formBuilder
                .addRow("Platba licencí od").addField("gstaticfield", { name: "dat_plat_lic_od", /*valueType: "datetime", hideZeroTime: true,*/ customClass: "font-weight: bold" }) //RC 33115399 : Poslední export do KOF
        }
        else {
            formBuilder
        ...
        if (dto.dat_exp_kof != undefined) {
            formBuilder
                .addRow("jres:33115399").addField("gstaticfield", { name: "dat_exp_kof", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115399 : Poslední export do KOF
        }
        else {
            formBuilder
        ...
        if (dto.posledni_fakturace != undefined) {
            formBuilder
                .addRow("jres:33115400").addField("gstaticfield", { name: "posledni_fakturace", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115400 : Poslední fakturace
        }
        else {
            formBuilder
        ...
        if (dto.pristi_fakturace != undefined) {
            formBuilder
                .addRow("jres:33115401").addField("gstaticfield", { name: "pristi_fakturace", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115401 : Příští fakturace
        }
        else {
            formBuilder
        ...
        formBuilder
            .addRow("jres:33115184").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115184 : Poslední změna
...
Gordic.Previews.register("adt:IcoProAdministraci", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115191").addField("gstaticfield", { //RC 33115191 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
...
Gordic.Previews.register("adt:StatistikaFazi", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115306").addField("gstaticfield", { name: "dat_login_max", itemTemplate: "{#:datetime}", valueType: "datetime", customClass: "font-weight: bold" }) //RC 33115306 : Poslední přihlášení
            .addRow("jres:33115307").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", customClass: "font-weight: bold" }) //RC 33115307 : Aktuální k
...
Gordic.Previews.register("adt:AktReinstBal", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115245").addField("gstaticfield", { name: "sub_verze_db" }) //RC 33115245 : Subverze databáze
            .addRow("jres:33115247").addField("gstaticfield", { name: "revize_adz" }) //RC 33115247 : Revize subverze databáze
            .addRow("jres:33115180").addField("gdatebgstaticfieldox", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115180 : Platnost od
...
Gordic.Previews.register("adt:ReinstBal", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            .addSection()
            .addRow("jres:33115431").addField("gstaticfield", { //RC 33115431 : GDZ balík
                name: "verze_db",
                itemTemplate: function (obj) {
            ...
            .addRow("jres:33115432").addField("gstaticfield", { name: "vyvoj_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115432 : Vývoj od
            .addRow("jres:33115433").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115433 : Vznik GDZ
            .addRow("jres:33115244").addField("gstaticfield", { name: "verze_db" }) //RC 33115244 : Hlavní verze databáze GINIS
            .addRow("jres:33115245").addField("gstaticfield", { name: "sub_verze_db" }) //RC 33115245 : Subverze databáze
            .addRow("jres:33115247").addField("gstaticfield", { name: "revize_adz" }) //RC 33115247 : Revize subverze databáze
...
Gordic.Previews.register("adt:VydaneVerze", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115245").addField("gstaticfield", { name: "sub_verze_db" }) //RC 33115245 : Subverze databáze
            .addRow("jres:33115247").addField("gstaticfield", { name: "revize_adz" }) //RC 33115247 : Revize subverze databáze
            .addRow("jres:33115434").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115434 : Vývoj od
            .addRow("jres:33115435").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115435 : Vznik GDZ
            .addRow("jres:33115440").addField("gstaticfield", { //RC 33115440 : Stav
                name: "stav_rev_adz",
                itemTemplate: function (obj) {
                    if (obj == 0) {
                        return "jres:33115257"; //RC 33115257 : Vývoj
...
Gordic.Previews.register("adt:ProduktoveListy", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115192").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115192 : Poslední změna
...
Gordic.Previews.register("adt:SeznamProduktu", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            .addSection()
            .addRow("Programová fáze").addField("gstaticfield", { name: "faze" }) 
            .addRow("Stav fáze")
            .addField("gstaticfield", {
                name: "stav_faze_txt",
                //customClass: "w-0",
                //badge: { id: "stav_faze", value: dto.stav_faze_txt, customClass: "w-6" /*((dto.stav_faze_txt == "Neurčeno") ? ".faze-stav-neurceno" : (dto.stav_faze_txt == "Perspektivní") ? ".faze-stav-perspektivni" : "g-state-success")*/ }
            })
            .addRow("jres:33115448").addField("gstaticfield", { name: "modul" }) //RC 33115448 : Zkratka
            .addRow("jres:33115506").addField("gstaticfield", { name: "faze_txt" }) //RC 33115506 : Název
            .addRow("Typ fáze").addField("gstaticfield", {
                name: "faze_typ_txt",
            }) 
            //.addRow("Stav fáze").addField("gstatic", {
            //    name: "stav_faze_txt",
            //    customClass: "w-0",
            //    badge: { id: "stav_faze", value: dto.stav_faze_txt, customClass: "stav_faze" /*((dto.stav_faze_txt == "Neurčeno") ? ".faze-stav-neurceno" : (dto.stav_faze_txt == "Perspektivní") ? ".faze-stav-perspektivni" : "g-state-success")*/}
            //})
            ...
            .addRow("Platnost do").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115192 : Poslední změna
            ...
            .addRow("Změněno").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115192 : Poslední změna
            .addRow("jres:33115193").addField("gstaticfield", { name: "zmenil" }) //RC 33115193 : Změnil

        form.gform("createFrom", formBuilder).findFields().gfield("model", "apply", dto);
        var badge = form.find("div")[9]
        var badge = form.find("div")[9]
        //form.find("div")[9].color = "white"
        //form.find("div")[9].style.fontSize = '98%'
        //form.find("div")[9].style.fontWeight = 550
        //if (form.find("div")[9].innerText == 'Neurčeno') {
        //    form.find("div")[9].style.backgroundColor = '#FFD700'
        //}
        //else if (form.find("div")[9].innerText == 'Ukončená') {
        //    form.find("div")[9].style.backgroundColor = '#808080'
        //}
        //else if (form.find("div")[9].innerText == 'Neperspektivní') {
        //    form.find("div")[9].style.backgroundColor = '#C63C3C'
        //}
        //else if (form.find("div")[9].innerText == 'Dočasná') {
        //    form.find("div")[9].style.backgroundColor = '#FFB266'
        //}
        //else if (form.find("div")[9].innerText == 'Vývoj') {
        //    form.find("div")[9].style.backgroundColor = '#6699FF'
        //}
        //else if (form.find("div")[9].innerText == 'K testování') {
        //    form.find("div")[9].style.backgroundColor = '#2650B9'
        //}
        //else if (form.find("div")[9].innerText == 'Nová') {
        //    form.find("div")[9].style.backgroundColor = '#27B779'
        //}
        //else if (form.find("div")[9].innerText == 'Perspektivní') {
        //    form.find("div")[9].style.backgroundColor = 'black'
        //}
        //form.find("div")[9].style.marginLeft = '5px'
        //form.find("div")[9].style.marginTop = '9px'
        //form.find("div")[9].style.width = 'fit-content'
        if (form.find("div")[9].innerText == 'Neurčeno') {
            form.find("div")[9].style.color = '#FFD700'
            form.find("div")[9].style.fontWeight = 'bold'
        }
        else if (form.find("div")[9].innerText == 'Ukončená') {
            form.find("div")[9].style.color = '#808080'
            form.find("div")[9].style.fontWeight = 'normal'
        }
        else if (form.find("div")[9].innerText == 'Neperspektivní') {
            form.find("div")[9].style.color = '#C63C3C'
            form.find("div")[9].style.fontWeight = 'bold'
        }
        else if (form.find("div")[9].innerText == 'Dočasná') {
            form.find("div")[9].style.color = 'saddlebrown'
            form.find("div")[9].style.fontWeight = 'normal'
        }
        else if (form.find("div")[9].innerText == 'Vývoj') {
            form.find("div")[9].style.color = '#6699FF'
            form.find("div")[9].style.fontWeight = 'normal'
        }
        else if (form.find("div")[9].innerText == 'K testování') {
            form.find("div")[9].style.color = '#2650B9'
            form.find("div")[9].style.fontWeight = 'bold'
        }
        else if (form.find("div")[9].innerText == 'Nová') {
            form.find("div")[9].style.color = '#27B779'
            form.find("div")[9].style.fontWeight = 'bold'
        }
        else if (form.find("div")[9].innerText == 'Perspektivní') {
            form.find("div")[9].style.color = 'black'
            form.find("div")[9].style.fontWeight = 'bold'
        }
        currentElement.resize().find(".gform-section").children("label").first().addClass("g-state-text g-state-active");
    },
...
Gordic.Previews.register("adt:PrehledORJ", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("Kategorie ORJ").addField("gstaticfield", { //RC 33115191 : Aktivita
                name: "ktg_orj",
                itemTemplate: function (obj) {
                    if (obj == 0) {
...
Gordic.Previews.register("adt:Produkty", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115196").addField("gstaticfield", { //RC 33115196 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
        ...
        formBuilder
            ...
            .addRow("jres:33115352").addField("gstaticfield", { name: "poznamka" }) //RC 33115352 : Poznámka
            .addRow("jres:33115197").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115197 : Poslední změna
            .addRow("jres:33115198").addField("gstaticfield", { name: "zmenil" }) //RC 33115198 : Změnil
            .addRow("jres:33115199").addField("gstaticfield", { //RC 33115199 : Kategorie
                name: "ktg_pol",
                itemTemplate: function (obj) {
                    if (obj == 0) {
...
Gordic.Previews.register("adt:BalikyProduktu", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115206").addField("gstaticfield", { //RC 33115206 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115207").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115207 : Poslední změna
...
Gordic.Previews.register("adt:SkupinyProduktu", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115213").addField("gstaticfield", { //RC 33115213 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115214").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115214 : Poslední změna
...
Gordic.Previews.register("adt:Ceniky", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115221").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115221 : Platnost od
            .addRow("jres:33115222").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115222 : Platnost do
            .addRow("jres:33115223").addField("gstaticfield", { //RC 33115223 : Aktivita
                name: "aktivita",
                itemTemplate: function (obj) {
                    if (obj == 100) {
                        return "jres:33115020"; //RC 33115020 : Aktivní
            ...
            .addRow("jres:33115224").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115224 : Poslední změna
...
Gordic.Previews.register("adt:Chyby", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("Platnost licence od").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115107 : Platnost od
        if (dto.posledni_fakturace != undefined) {
            formBuilder
                .addRow("Poslední fakturace licenčních poplatků").addField("gstaticfield", { name: "posledni_fakturace", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115108 : Platnost do
        }
        else {
            formBuilder
        ...
        formBuilder
            ...
            .addRow("Platnost licence do").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115108 : Platnost do
        if (dto.stav_kontroly_lic != "OK") {
            formBuilder
        ...
        formBuilder
            ...
            .addRow("Poslední změna licence").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" })
            .addRow("Změnil").addField("gstaticfield", { name: "zmenil" })
            .addRow("Důvod").addField("gstaticfield", { name: "duvod" })
            .addRow("Datum nákupu").addField("gstaticfield", { name: "dat_nakup", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" })
            ...
            .addRow("Poslední fakturace licenčních poplatků na IČO a Pol").addField("gstaticfield", { name: "posledni_fakturace", itemTemplate: "{#:date}", })
...
Gordic.Previews.register("adt:HistorieKontroly", {
    ...
    render: function (div, dto) {
        ...
        formBuilder
            ...
            .addRow("Kontrolováno").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", customClass: "font-weight: bold" })
...
Gordic.Previews.register("adt:VyjimkyDatabaze", {
    ...
    render: function (div, dto) {
        ...
        var formBuilder = new Gordic.Forms.Form({ layoutDescriptor: "L1M1S1, breaks-500-600" })  //breaks-300-400
            ...
            .addRow("jres:33115107").addField("gstaticfield", { name: "dat_od", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115107 : Platnost od
            .addRow("jres:33115108").addField("gstaticfield", { name: "dat_do", itemTemplate: "{#:date}", valueType: "date", customClass: "font-weight: bold" }) //RC 33115108 : Platnost do
            .addRow("jres:33115109").addField("gstaticfield", { name: "popis" }) //RC 33115109 : Popis
            .addRow("jres:33115110").addField("gstaticfield", { name: "dat_zmena", itemTemplate: "{#:datetime}", valueType: "datetime", hideZeroTime: true, customClass: "font-weight: bold" }) //RC 33115110 : Poslední změna
