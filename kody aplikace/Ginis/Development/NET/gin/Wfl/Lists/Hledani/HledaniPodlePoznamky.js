(function ($) {
    "use strict";
    namespace("Gordic.Wfl.Hledani.HledaniPodlePoznamky", {

        onContentReady: function () {
            var that = this;
            this.title = "jres:26225128"; //RC 26225128 : Hledání podle poznámky

            var dateFactors = [
                { caption: "jres:26225290", factor: "DP" }, //RC 26225290 : Datum podání
            ];

            var filterForm = new Gordic.Forms.Form({ name: "FormHledaniPoznamky", tabLabel: "jres:26227188", layoutDescriptor: "L2M2S1, L-4-7-1, M-12-11-1, S-12-11-1" })
                .addSection()
                .addRow({ label: "jres:26225312", required: true }) //RC 26225312 : Poznámka
                .addField("gstringbox", {
                    name: "poznamkaField",
                    model: "Poznamka",
                ...
                .addField("gloadlink", {
                    ...
                    load: function(parentDiv) {
                        $("<span>jres:26225549</span>").appendTo(parentDiv) //RC 26225549 : Při tomto hledání musí být zadány alespoň 2 znaky z poznámky, k tomu je nutné vyplnit vlastníka  nebo datum podání.

                        /* var form = $("<div>").appendTo(obj.parentDiv);
                         var Form = new Gordic.Forms.Form("L1M1S1, L-12-12-0 , M-12-12-0, S-12-12-0, breaks-800-1000");

                         Form.addRow("jres:26225549"); //RC 26225549 : Při tomto hledání musí být zadány alespoň 2 znaky z poznámky, k tomu je nutné vyplnit vlastníka  nebo datum podání.
            ...
            this.$filterForm = $("<div>")
                ...
                .gfilterpanel({
                    ...
                    favorites: ["poznamkaField", "suField", "dateIntervalField"],        //defaulty oblibenych polozek - udava se name radku, nebo name prvniho prvku v radku (nefunguje uvedeni name policka, pokud lezi na radku s definovanym name)
