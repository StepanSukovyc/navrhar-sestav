(function ($) {
    "use strict";
    namespace("Gordic.Wfl.Hledani.HledaniPodleOdesilatele", {

        onContentReady: function () {
            var that = this;
            this.title = "jres:26225124"; //RC 26225124 : Hledání podle odesílatele

            var dateFactors = [
                { caption: "jres:26225290", factor: "DP" }, //RC 26225290 : Datum podání
            ];

            var filterForm = new Gordic.Forms.Form({ name: "FormHledaniOdesilatele", tabLabel: "jres:26227188", layoutDescriptor: "L2M2S1, L-4-7-1, M-12-11-1, S-12-11-1" })
                .addSection()
                .addRow({ label: "jres:26225446", required: true }) //RC 26225446 : Odesílatel
                .addField("gselectbox", {
                    name: "odesilatelField",
                ...
                .addPrefab(Gordic.Wfl.Prefabs.FilterUpresneniHledani({
                    ...
                    VcetneStornovanychVisible: true,
                }))
                ...
                .addField("gloadlink", {
                    ...
                    load: function(parentDiv) {
                        $("<span>jres:26225548</span>").appendTo(parentDiv) //RC 26225548 : Při tomto hledání musí být vyplněn odesílatel, doporučujeme vybrat i jednu z dalších položek.
                    }
                });
            ...
            this.$filterForm = $("<div>")
                ...
                .gfilterpanel({
                    ...
                    favorites: ["odesilatelField", "suField", "dateIntervalField"],  //defaulty oblibenych polozek - udava se name radku, nebo name prvniho prvku v radku (nefunguje uvedeni name policka, pokud lezi na radku s definovanym name)
                    tema: "ssl_ptm_hledode",
