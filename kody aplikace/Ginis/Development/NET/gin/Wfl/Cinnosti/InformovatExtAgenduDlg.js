(function ($) {
    "use strict";
    namespace("Gordic.Wfl.InformovatExtgAgendu", {
                            ...
                            .gformrow("addFieldsRow", "jres:26225948", ["w-12"]).gselectbox( //RC 26225948 : Externí systém
                                Gordic.Prefabs.Select.intsext(),
                                {
                                    ...
                                    serverFilters: {
                                        ...
                                        PovolenDleTypuDokumentuVIntvaty: ((this.gin_extag_inft === 1) && this.IxsTyp) ? this.IxsTyp : undefined,
                                        ...
                                        //ixs_ext: this.FilterIxsExt ? this.FilterIxsExt : undefined
                                        ixs_ext: { o: ["IN"], v: this.FilterIxsExt.replaceAll("'","").split(',') }
