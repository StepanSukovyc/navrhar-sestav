(function ($) {
    "use strict";
    namespace("Gordic.Maj.WebClient.GHledaniDokladuJsGrid", {

        taskId: "actDklFind",    

        prepareContent: function (args) {
            console.log("GHledaniDokladuJsGrid", args, this);
                ...
                action: new GAction({
                    ...
                    run: function () {
                        ...
                        if (selectedDkl === undefined) {
                            ...
                            console.log("Gordic.Maj.WebClient.GHledaniDokladuJsGrid - Otevírám doklad ", selectedDkl.ixp);
            ...
            this.srv = new GContent({ className: "Gordic.Maj.WebClient.GHledaniDokladuJsGrid", params: { MyFoo: "abc" } });  //sluzba pro pristup k datum na serveru + predani parametru
                ...
                .ggrid({
                    ...
                    defaultAction: new GAction({     //obsluzna akce, ktera se spousti dbl clickem nad radkem
                        ...
                        run: function (ev, ctx) {
                            ...
                            console.log("Gordic.Maj.WebClient.GHledaniDokladuJsGrid - Otevírám doklad ", row.ixp);
