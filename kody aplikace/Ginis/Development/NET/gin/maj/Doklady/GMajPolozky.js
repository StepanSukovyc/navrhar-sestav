(function ($) {
    "use strict";
    namespace("Gordic.Maj.WebClient.GMajPolozky", {
        taskId: "actDklPol",    // { frm_MajPol }           

        onContentReady: function () {

            console.log("Gordic.Maj.WebClient.GMajPolozky.onContentReady", this);
            var that = this;
            ...
            var actPohyby = new GAction({
                ...
                icon: "gi-list",
                run: function (ev, ctx) { // frm_MajPol.showPohyb( )   - Call SalModalDialog( dlg_MajPep,hWndForm,ng_modepepDok,tbl_Mud.ixp,tbl_Mud.ac,0,'','','', 0 )
            ...
            //actPohyby.enabled(this.cvPbNewEnabled);
            ...
            this.setBreadcrumbs([
                { caption: "jres:24534356" }, //RC 24534356 : Přehled položek maj. dokladů aktuální knihy
                {
            ...
            this.srv = new GContent({ className: "Gordic.Maj.WebClient.GMajPolozky", params: { } });  //sluzba pro pristup k datum na serveru + predani parametru
                ...
                .ggrid({
                    ...
                    columns: new Gordic.Data.GridFormat()
                        ...
                        .addNumberColumn({
                            ...
                            caption: "# pol",
                            width: colWidthSmall,
                            hidden: this.cvColSerCisloVis
                        })
                        .addNumberColumn({
                            name: "ser_pcislo",
                            caption: "# poh",
                            width: colWidthSmall,
                            hidden: this.cvColSerPCisloVis   // pro položky schovat
                        })
                        .addTextColumn({
                            name: "mp_stav_zkr",
                            caption: "S",
                        ...
                        .addTextColumn({
                            name: "inv_cis",
                            caption: this.cvColInvCisName,
                            width: 120,
                            hidden: this.cvColInvCisVis
                        })
                        .addTextColumn({
                            name: "mat_cis",
                            caption: this.cvColMatCisName,
                            width: 120,
                            hidden: this.cvColMatCisVis
                        })
                        .addTextColumn({
                            name: "ueab_evi",
                            caption: this.cvColUeabEviName,
                            width: colWidthSuAu,
                            hidden: this.cvColUeabEviVis
                        })
                        .addTextColumn({ // TODO: proč je vidět?
                            name: "nazev",
                            caption: this.cvColNazevName,
                            width: 150,
                            hidden: this.cvColNazevVis
                        })
                        .addCurrencyColumn({
                            name: "m",
                            // HONZA: v jednom seznam je "Množství", v druhém "Počet MJ"...
                        ...
                        .addCurrencyColumn({
                            ...
                            width: colWidthMoney,
                            hidden: this.HideCiziMena   // GM_SetVisible - 380.21 12.07.18 zobrazení měny, ceny v měně  - pokud budou všechny záznamy v CZK, sloupce nebudou vidět
                        })
                        .addTextColumn({
                            name: "mena_zkr",
                            caption: "jres:24534342", //RC 24534342 : Měna
                            width: colWidthSmall,
                            hidden: this.HideCiziMena    // GM_SetVisible
                        })
                        .addNumberColumn({
                            name: "kurz",
                        ...
                        .addTextColumn({
                            name: "skp",
                            caption: this.cvColSkpName,
                            width: 100,
                            hidden: this.cvColSkpVis
                        })
                        .addTextColumn({
                            name: "mj",
                            caption: this.cvColMjName,
                            width: colWidthSmall,
                            hidden: this.cvColMjVis
                        })
                        .addTextColumn({
                            name: "vyr_cis",
                        ...
                        .addTextColumn({
                            ...
                            width: colWidthPid - 20,
                            hidden: this.cvColEvsVis
                        })
                        .addTextColumn({
                            name: "nks_ext",
                            caption: this.cvColNsExtName,
                            width: colWidthPid - 20
                        })
                        ...
                        .addTextColumn({
                            name: "ueab_por",
                            caption: this.cvColUeabPorName,
                            width: colWidthSuAu,
                            hidden: this.cvColUeabPorVis
                        })
                        .addTextColumn({
                            name: "ueab_opr",
                            caption: this.cvColUeabOprName,
                            width: colWidthSuAu,
                            hidden: this.cvColUeabOprVis
                        })
                        ...
                        // 378.5 20.12.16 nákladové položky
                        .addTextColumn({
                            name: "naklad_p1",
