...
//    <Name>          Gordic.General.GInt32Converter.cs          </Name>
...
namespace Gordic.General {
	...
	/// <summary>typový konvertor pro databázový typ GInt32</summary>
	public class GInt32Converter : TypeConverter {
        ...
        public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object sourceValue) {
            if (sourceValue is string && sourceValue!=null) return GInt32.Parse((string) sourceValue,culture);
            else if(sourceValue is GString && ((GString) sourceValue).IsNull==false) return GInt32.Parse(sourceValue.ToString(),culture);
            else return GInt32.Parse(sourceValue,true);
        } // end method
        ...
        public override object ConvertTo(ITypeDescriptorContext context,CultureInfo culture, object sourceValue, Type destinationType) {  
            if(destinationType == null) throw new GArgumentNullException(23200100); // nebyla nastavena hodnota oèekávaného parametru
            GInt32 l_oSourceValue = sourceValue as GInt32;
            if(l_oSourceValue != null) {
                try {
                    ...
                    else if(destinationType == typeof(GInt32)) return l_oSourceValue.Clone();
                    ...
                    if(e is GException == false) throw new GOverflowException(23200103,e); // velikost hodnoty pøesáhla limit použitého datového typu
                    else throw;
                } // end catch
            } // end if
            throw new GInvalidCastException(23200101); // pokus o nepovolenou typovou konverzi
        } // end method
