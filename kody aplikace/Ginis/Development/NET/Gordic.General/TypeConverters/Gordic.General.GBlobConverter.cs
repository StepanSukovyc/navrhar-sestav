...
//    <Name>          Gordic.General.GBlobConverter.cs          </Name>
...
namespace Gordic.General
{
    ...
    /// <summary>typový konvertor pro databázový typ GBlob</summary>
	public class GBlobConverter : TypeConverter
    {
        ...
        {
            throw new GInvalidCastException( 21300003, 23200032 ); // pokus o nepovolenou typovou konverzi //RC-EX 23200032 : pokus o nepovolenou typovou konverzi
        } // end method
        ...
        {
            throw new GInvalidCastException( 21300004, 23200032 ); // pokus o nepovolenou typovou konverzi //RC-EX 21300015 : pokus o nepovolenou typovou konverzi
        } // end method
