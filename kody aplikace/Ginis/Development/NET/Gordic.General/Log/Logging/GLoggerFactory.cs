...
//    <Name>        Gordic.General.GLoggerFactory.cs                            </Name>
//    <Description> Produces instances of <see cref="IGLogger"/> classes based on the given providers.</Description>
...
// LoggerFactory - k èemu je dobrá? - možnost více RÙZNÝCH KONFIGURAÈNÍCH SOUBORÙ (sometimes you want to create a SEPARATE LOGGING CONFIGURATION, just for a particular component, plugin or extension)
// https://github.com/NLog/NLog/wiki/Configure-component-logging

namespace Gordic.General
{
    /// <summary>
    /// Produces instances of <see cref="IGLogger"/> classes based on the given providers.
    /// </summary>
    internal class GLoggerFactory //: IGLoggerFactory
    {   // !!zámìrnì protected, aby novou GLoggerFactory vytváøeli lidi jen naprosto výjimeènì
        // TODO: udìlat do GLoggerFactory napojení na konfiguraèní soubor (jiný než pùvodní)

        /// <summary>
        /// Creates a new <see cref="GLoggerFactory"/> instance.
        /// </summary>
        protected GLoggerFactory()
        {
            // vlastní konstruktor
        }

        // naše rozšíøení - inspirace
        // private static Logger s_oLogger = LogManager.GetCurrentClassLogger();

        /// <summary>
        /// Vrátí logger na základì aktuální tøídy
        /// </summary>
        /// <returns></returns>
        protected static IGLogger CurrentClassLogger()
        {
            return null;
        ...
        /// <summary>
        /// Creates an <see cref="IGLogger"/> with the given <paramref name="categoryName"/>.
        /// </summary>
        /// <param name="categoryName">The category name for messages produced by the logger.</param>
        /// <returns>The <see cref="IGLogger"/> that was created.</returns>
        protected IGLogger CreateLogger(string categoryName)
        {
            // TODO: log - doplnit obsah
            //if (CheckDisposed())
            //{
            //    throw new ObjectDisposedException(nameof(LoggerFactory));
            //}

            var l_oNLogger = LogManager.GetLogger(categoryName);    // loggerType:
                                                                    //     The logger class. This class must inherit from NLog.Logger.
