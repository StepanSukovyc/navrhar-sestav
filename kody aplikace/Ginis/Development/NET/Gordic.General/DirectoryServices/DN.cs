...
//    <Name>        Gordic.General.DN.cs                                        </Name>
//    <Description> A distinguished name (DN) is a name that uniquely identifies an object in an LDAP</Description>
...
namespace Gordic.General.DirectoryServices
{
	...
	public class DN
	{
		...
		private static DNEscapeChars defaultEscapeChars = DNEscapeChars.ControlChars | DNEscapeChars.SpecialChars;
		...
		private DNEscapeChars escapeChars;
		...
		/// </summary>
		public DNEscapeChars CharsToEscape
		{
			get
			{
				return escapeChars;
		...
		public DN(string dnString, DNEscapeChars escapeChars)
		{
            if (dnString == null)
            {
		...
		private DN(RDNList rdnList, DNEscapeChars escapeChars)
		{
			this.escapeChars = escapeChars;
		...
		/// <returns>a string that represents the current DN</returns>
		public string ToString(DNEscapeChars escapeChars)
		{
		...
		/// </summary>
		public static DNEscapeChars DefaultEscapeChars
		{
			get
			{
