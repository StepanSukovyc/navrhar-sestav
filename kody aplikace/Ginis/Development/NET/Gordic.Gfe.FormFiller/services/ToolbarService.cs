...
//    <Name>        Gordic.Gfe.FormFiller.ToolbarService.cs                     </Name>
    ...
    static class ToolbarService
    {
        ...
        static object CreateToolbarItemFromDescriptor(ToolbarItemDescriptor descriptor)
        {
            ...
            switch (type)
            {
                ...
                default:
                    throw new System.NotSupportedException(string.Format(GResources.GetResourceText(29450087) + ": '{0}'!", type)); //RC 29450087 : Nepodporovaná položka menu typu
            }
        }
