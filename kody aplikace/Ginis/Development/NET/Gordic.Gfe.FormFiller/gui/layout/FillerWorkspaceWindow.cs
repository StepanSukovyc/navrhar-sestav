...
//    <Name>        Gordic.Gfe.FormFiller.FillerWorkspaceWindow.cs              </Name>
//    <Description> Uvolnění položek                                            </Description>
...
{
    class FillerWorkspaceWindow : DockContent, IWorkspaceWindow
    {
        ...
        /// pohled na záložky
        /// </summary>
        public TabControl ViewTabControl { get { return viewTabControl; } }
        /// <summary>
        /// viditelné pohledy
        /// </summary>
        List<IViewContent> visibleContents = null;
        /// <summary>
        /// Získání/Nastavení kolekce viditelných pohledů pracovního prostoru
        /// </summary>
        public List<IViewContent> VisibleContents { get { return visibleContents; } set { visibleContents = value; } }
        ...
        public void CreateViewTabControl()
        {
            if (viewTabControl == null)
            {
                ...
                {
                    if (viewTabControl.SelectedTab.Controls.Count != 0 && !viewTabControl.SelectedTab.ContainsFocus)
                ...
                viewTabControl.SelectedIndexChanged += delegate { UpdateActiveViewContent(); };
            }
        }
        /// <exclude/>
        ...
        public IViewContent ActiveViewContent
        {
            get
            {
                Debug.Assert(ThreadService.InvokeRequired == false);
                ...
                if (viewTabControl != null && viewTabControl.SelectedIndex >= 0 && viewTabControl.SelectedIndex < ViewContents.Count)
                    return visibleContents[viewTabControl.SelectedIndex];
                else return visibleContents.FirstOrNull(itm => itm.Visible);
            }
            set
            {
                int pos = ViewContents.IndexOf(value);
                if (pos < 0)
                    throw new ArgumentException(GResources.GetResourceText(29450062)); //RC 29450062 : Obsah neexistuje!
                SwitchView(pos);
            }
        }
        ...
        public bool CloseWindow(bool force)
        {
            ...
            {
                DialogResult dr = MessageBox.Show(GResources.GetResourceText(29450063), //RC 29450063 : Chcete uložit aktuální změny?
                                                  string.Format(GResources.GetResourceText(29450064) + " '{0}'?", Title), //RC 29450064 : Uložit změny v
                    ...
                    case DialogResult.Yes:
                        foreach (IViewContent vc in this.ViewContents)
                            while (vc.IsDirty)
                            {
                                SaveFile.Save(vc);
                                if (vc.IsDirty)
                                    if (MessageService.AskQuestion(GResources.GetResourceText(29450065))) //RC 29450065 : Opravdu chcete zrušit provedené změny?
                                    {
                                        fileDiscarded = true;
                                        break;
                                    }
            ...
            if (filesToReparse != null)
            {
                ...
                LoggingService.Debug("FillerWorkspaceWindow " + GResources.GetResourceText(29450066) + ": " + String.Join(", ", filesToReparse)); //RC 29450066 : se uzavře bez uložení změn, soubory pro analýzu
        ...
        readonly static string contextMenuPath = "/FormFiller/Desktop/OpenFileTab/ContextMenu";
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FillerWorkspaceWindow));
            this.SuspendLayout();
            // 
            // FillerWorkspaceWindow
            // 
            resources.ApplyResources(this, "$this");
            this.Name = "FillerWorkspaceWindow";
