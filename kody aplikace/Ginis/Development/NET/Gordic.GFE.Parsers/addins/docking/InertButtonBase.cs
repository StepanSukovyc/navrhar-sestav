...
//    <Name>        Gordic.GFE.Parsers.InertButtonBase.cs                     </Name>
//    <Description> Základní nekativní tlaèítko                                 </Description>
...
namespace Gordic.GFE.Parsers.Docking
{
    ...
    abstract class InertButtonBase : Control
    {
        ...
        {
            get { return WinFormsResourceService.GetBitmap("DockPane_Close").Size; }
        }
