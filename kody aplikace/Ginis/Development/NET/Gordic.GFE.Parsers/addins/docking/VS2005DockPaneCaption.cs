...
//    <Name>        Gordic.GFE.Parsers.VS2005DockPaneCaption.cs               </Name>
//    <Description> Automaticky skrývající se podokno                           </Description>
...
{
    /// <summary>
    /// Automaticky skrývající se podokno 
    /// </summary>
    internal class VS2005DockPaneCaption : DockPaneCaptionBase
    {
        ...
        private static Bitmap ImageButtonClose
        {
            get
            {
                if (_imageButtonClose == null)
                    _imageButtonClose = WinFormsResourceService.GetBitmap("DockPane_Close");
        ...
        private static Bitmap ImageButtonAutoHide
        {
            get
            {
                if (_imageButtonAutoHide == null)
                    _imageButtonAutoHide = WinFormsResourceService.GetBitmap("DockPane_AutoHide");
        ...
        private static Bitmap ImageButtonDock
        {
            get
            {
                if (_imageButtonDock == null)
                    _imageButtonDock = WinFormsResourceService.GetBitmap("DockPane_Dock");
        ...
        private static Bitmap ImageButtonOptions
        {
            get
            {
                if (_imageButtonOptions == null)
                    _imageButtonOptions = WinFormsResourceService.GetBitmap("DockPane_Option");
        ...
        private static string ToolTipClose
        {
            get
            {
                if (_toolTipClose == null)
                    _toolTipClose = GResources.GetResourceText(29450085); //RC 29450085 : zavøít
        ...
        private static string ToolTipOptions
        {
            get
            {
                if (_toolTipOptions == null)
                    _toolTipOptions = GResources.GetResourceText(29450086); //RC 29450086 : volby
        ...
        private static string ToolTipAutoHide
        {
            get
            {
                if (_toolTipAutoHide == null)
                    _toolTipAutoHide = GResources.GetResourceText(29450087); //RC 29450087 : automaticky skrýt
        ...
        {
            // nastavení velikosti a umístìní v blízkosti tlaèítka pro automatické skrýti
            Rectangle rectCaption = ClientRectangle;
