...
//    <Name>        Gordic.GFE.Parsers.DockPanel.MdiClientController.cs       </Name>
...
namespace Gordic.GFE.Parsers.Docking
{
    ...
    partial class DockPanel
    {
        ...
        class MdiClientController : NativeWindow, IComponent, IDisposable
        {
            ...
            public BorderStyle BorderStyle
            {
                set
                {
                    ...
                    int style = Gordic.GFE.Parsers.Utils.NativeMethods.GetWindowLong(MdiClient.Handle, (int)GetWindowLongIndex.GWL_STYLE);
                    int exStyle = Gordic.GFE.Parsers.Utils.NativeMethods.GetWindowLong(MdiClient.Handle, (int)GetWindowLongIndex.GWL_EXSTYLE);
                    ...
                    Gordic.GFE.Parsers.Utils.NativeMethods.SetWindowLong(MdiClient.Handle, (int)GetWindowLongIndex.GWL_STYLE, style);
                    Gordic.GFE.Parsers.Utils.NativeMethods.SetWindowLong(MdiClient.Handle, (int)GetWindowLongIndex.GWL_EXSTYLE, exStyle);
            ...
            public MdiClient MdiClient { get { return m_mdiClient; } }
            ...
            protected override void WndProc(ref Message m)
            {
                switch (m.Msg)
                {
                    case (int)Msgs.WM_NCCALCSIZE:
                        ...
                        if (!AutoScroll)
                            Gordic.GFE.Parsers.Utils.NativeMethods.ShowScrollBar(m.HWnd, (int)ScrollBars.SB_BOTH, 0 /*false*/);
                        break;
                }
            ...
            private void UpdateStyles()
            {
                ...
                Gordic.GFE.Parsers.Utils.NativeMethods.SetWindowPos(MdiClient.Handle, IntPtr.Zero, 0, 0, 0, 0,
        ...
        private void ParentFormMdiChildActivate(object sender, EventArgs e)
        {
            ...
            if (!(GetMdiClientController().ParentForm.ActiveMdiChild is IDockContent content))
                return;
        ...
        private void SetMdiClient()
        {
            ...
            else if (DocumentStyle == DocumentStyle.DockingRdi || DocumentStyle == DocumentStyle.DockingWindow)
            {
