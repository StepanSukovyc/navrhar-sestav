...
namespace Gordic.GFE.Parsers.Docking
{
    ...
    partial class DockPanel
    {
        ...
        private class FocusManagerImpl : Component, IContentFocusManager, IFocusManager
        {
            ...
            private List<IDockContent> ListContent { get { return m_listContent; } }
            ...
            private bool InRefreshActiveWindow { get { return m_inRefreshActiveWindow; } }
        ...
        private IFocusManager FocusManager { get { return m_focusManager; } }
        ...
        {
            ((EventHandler)Events[ActiveDocumentChangedEvent])?.Invoke(this, e);
        }
        ...
        {
            ((EventHandler)Events[ActivePaneChangedEvent])?.Invoke(this, e);
        }
    }
}
