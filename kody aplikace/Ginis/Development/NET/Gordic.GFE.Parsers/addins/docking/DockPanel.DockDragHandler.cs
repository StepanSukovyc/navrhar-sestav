...
//    <Name>        Gordic.GFE.Parsers.DockPanel.DockDragHandler.cs           </Name>
        ...
        sealed class DockDragHandler : DragHandler
        {
            class DockIndicator : DragForm
            {
                ...
                class PanelIndicator : PictureBox, IHitTest
                {
                    ...
                    private DockStyle DockStyle { get { return m_dockStyle; } }
                    ...
                    private static readonly Image _imagePanelLeft = WinFormsResourceService.GetBitmap("DockIndicator_PanelLeft");
                    private static readonly Image _imagePanelRight = WinFormsResourceService.GetBitmap("DockIndicator_PanelRight");
                    private static readonly Image _imagePanelTop = WinFormsResourceService.GetBitmap("DockIndicator_PanelTop");
                    private static readonly Image _imagePanelBottom = WinFormsResourceService.GetBitmap("DockIndicator_PanelBottom");
                    private static readonly Image _imagePanelFill = WinFormsResourceService.GetBitmap("DockIndicator_PanelFill");
                    private static readonly Image _imagePanelLeftActive = WinFormsResourceService.GetBitmap("DockIndicator_PanelLeft_Active");
                    private static readonly Image _imagePanelRightActive = WinFormsResourceService.GetBitmap("DockIndicator_PanelRight_Active");
                    private static readonly Image _imagePanelTopActive = WinFormsResourceService.GetBitmap("DockIndicator_PanelTop_Active");
                    private static readonly Image _imagePanelBottomActive = WinFormsResourceService.GetBitmap("DockIndicator_PanelBottom_Active");
                    private static readonly Image _imagePanelFillActive = WinFormsResourceService.GetBitmap("DockIndicator_PanelFill_Active");

                    /// <summary>
                    /// vytvoøení nové instance tøídy
                    /// </summary>
                    /// <param name="dockStyle">styl dokovatelného okna</param>
                ...
                class PaneIndicator : PictureBox, IHitTest
                {
                    struct HotSpotIndex
                    {
                        ...
                        private readonly DockStyle m_dockStyle;
                        public DockStyle DockStyle { get { return m_dockStyle; } }
                    ...
                    private static Bitmap _bitmapPaneDiamond = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond");
                    private static readonly Bitmap _bitmapPaneDiamondLeft = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_Left");
                    private static readonly Bitmap _bitmapPaneDiamondRight = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_Right");
                    private static readonly Bitmap _bitmapPaneDiamondTop = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_Top");
                    private static readonly Bitmap _bitmapPaneDiamondBottom = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_Bottom");
                    private static readonly Bitmap _bitmapPaneDiamondFill = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_Fill");
                    private static Bitmap _bitmapPaneDiamondHotSpot = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_HotSpot");
                    private static Bitmap _bitmapPaneDiamondHotSpotIndex = WinFormsResourceService.GetBitmap("DockIndicator_PaneDiamond_HotSpotIndex");
                    ...
                    public static GraphicsPath DisplayingGraphicsPath { get { return _displayingGraphicsPath; } }
                ...
                public DockDragHandler DragHandler { get { return m_dragHandler; } }

                public DockPanel DockPanel { get { return DragHandler.DockPanel; } }
                ...
                private DockPane DisplayingPane { get { return ShouldPaneDiamondVisible() ? DockPane : null; } }
                ...
                bool ShouldPanelIndicatorVisible(DockState dockState)
                {
                    ...
                    return DragHandler.DragSource != null ? DragHandler.DragSource.IsDockStateValid(dockState) : false;
                }
            ...
            class DockOutline : DockOutlineBase, IDisposable
            {
                #region IDisposable
                /// <summary>
                /// uvolnìní objektu
                ...
                ~DockOutline() { Dispose(false); }
                #endregion

                DragForm m_dragForm;
                DragForm DragForm { get { return m_dragForm; } }

                protected override void OnShow() { CalculateRegion(); }
                protected override void OnClose() { DragForm.Close(); }
                ...
                void SetOutline() { SetDragForm(Rectangle.Empty); }
                void SetOutline(Rectangle floatWindowBounds) { SetDragForm(floatWindowBounds); }
            ...
            protected override void OnDragging() { TestDrop(); }
