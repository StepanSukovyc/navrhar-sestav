...
//    <Name>        Gordic.GFE.Parsers.DockPanel.AutoHideWindow.cs            </Name>
    ...
    partial class DockPanel
    {
        class AutoHideWindowControl : Panel, ISplitterDragSource
        {
            ...
            class SplitterControl : SplitterBase
            {
                ...
                /// </summary>
                /// <param name="autoHideWindow">okno</param>
                ...
                private AutoHideWindowControl AutoHideWindow { get { return m_autoHideWindow; } }

                /// <summary>
                /// velikost rozdìlovaèe
                /// </summary>
                protected override int SplitterSize { get { return Measures.SplitterSize; } }
                /// <summary>
                /// zaèátek tažení
                /// </summary>
                ...
                set
                {
                    ...
                    if (value != null)
                        if (!DockHelper.IsDockStateAutoHide(value.DockHandler.DockState) || value.DockHandler.DockPanel != DockPanel)
                            throw (new InvalidOperationException(GResources.GetResourceText(29450063) + '\n' + GResources.GetResourceText(29450078))); //RC 29450078 : obsah musí být auto-hide a asociovaný s DockPanel!
            ...
            /// stav dokování
            /// </summary>
            public DockState DockState { get { return ActiveContent == null ? DockState.Unknown : ActiveContent.DockHandler.DockState; } }
            ...
            const int ANIMATE_TIME = 100;	// v setiny vteøin

            Timer m_timerMouseTrack;
            ...
            public void RefreshActivePane() { SetTimerMouseTrack(); }

            /// <summary>
            /// uvolnìní objektu
            /// </summary>
            /// <param name="disposing">TRUE - objekt by mìl být uvolnìn</param>
            protected override void Dispose(bool disposing)
            {
                if (disposing && m_timerMouseTrack != null)
            ...
            void SetTimerMouseTrack()
            {
                ...
                // v pøípadì, že èasovaè má neplatnou hodnotu, se nastaví výchozí hodnota 400 
                if (hovertime <= 0)
                    hovertime = 400;
        ...
        AutoHideWindowControl AutoHideWindow { get { return m_autoHideWindow; } }

        internal Control AutoHideControl { get { return m_autoHideWindow; } }
