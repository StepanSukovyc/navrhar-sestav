...
//    <Name>        Gordic.GFE.Parsers.VS2005DockPaneStrip.cs                 </Name>
//    <Description> Pruh                                                        </Description>
...
namespace Gordic.GFE.Parsers.Docking
{
    ...
    internal class VS2005DockPaneStrip : DockPaneStripBase
    {
        ...
        private static Bitmap ImageButtonWindowList
        {
            get
            {
                if (_imageButtonWindowList == null)
                    _imageButtonWindowList = WinFormsResourceService.GetBitmap("DockPane_Option");
        ...
        private static Bitmap ImageButtonWindowListOverflow
        {
            get
            {
                if (_imageButtonWindowListOverflow == null)
                    _imageButtonWindowListOverflow = WinFormsResourceService.GetBitmap("DockPane_OptionOverflow");
        ...
        private static string ToolTipSelect
        {
            get
            {
                if (_toolTipSelect == null)
                    _toolTipSelect = GResources.GetResourceText(29450088); //RC 29450088 : seznam oken
        ...
        protected override void OnLayout(LayoutEventArgs levent)
        {
            ...
            // nastavení pozici a velikosti tlaèítek
