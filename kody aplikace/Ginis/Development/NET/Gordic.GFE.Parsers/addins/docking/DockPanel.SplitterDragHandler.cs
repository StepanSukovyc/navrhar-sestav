...
//    <Name>        Gordic.GFE.Parsers.DockPanel.SplitterDragHandler.cs       </Name>
//    <Description> Dokovácí panel                                              </Description>
...
namespace Gordic.GFE.Parsers.Docking
{
    ...
    partial class DockPanel
    {
        ...
        {
            class SplitterOutline : IDisposable
            {
                #region IDisposable
                /// <summary>
                /// uvolnìní objektu
                ...
                DragForm m_dragForm;
                private DragForm DragForm { get { return m_dragForm; } }

                public void Show(Rectangle rect) { SetDragForm(rect); }

                public void Close() { DragForm.Close(); }
