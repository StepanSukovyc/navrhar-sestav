...
//    <Name>        Gordic.GFE.WinClient.RdStatusBar.cs                         </Name>
//    <Description> Status Bar návrháře                                  </Description>
...
namespace Gordic.GFE.WinClient.Gui
{
    ...
    class DesignerStatusBar : StatusStrip
    {
        ...
        {
            SetMessage(GResources.GetResourceText(29450189) + ": " + message);
        }
        ...
        {
            SetMessage(image, GResources.GetResourceText(29450189) + ": " + message); //RC 29450189 : Chyba
        }
        /// <summary>
        /// Nastavení zprávy
        /// </summary>
