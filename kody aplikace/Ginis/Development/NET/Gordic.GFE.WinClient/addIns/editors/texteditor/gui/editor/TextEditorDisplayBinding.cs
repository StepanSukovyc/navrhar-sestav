...
//    <Name>        Gordic.GFE.Parsers.TextEditorDisplayBinding.cs            </Name>
    ...
    class TextEditorDisplayBinding : IDisplayBinding
    {
        ...
        public virtual IViewContent CreateContent(OpenedFile file)
        {
            ...
            catch (HighlightingDefinitionInvalidException ex)
            {
                ...
                MessageBox.Show(ex.ToString(), GResources.GetResourceText(29450189), MessageBoxButtons.OK, MessageBoxIcon.Error); //RC 29450189 : Chyba
            }
