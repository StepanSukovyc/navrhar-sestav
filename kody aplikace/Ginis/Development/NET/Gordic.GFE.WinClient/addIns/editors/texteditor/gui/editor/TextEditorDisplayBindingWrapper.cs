...
//    <Name>        Gordic.GFE.Parsers.TextEditorDisplayBindingWrapper.cs     </Name>
...
namespace Gordic.GFE.WinClient.DefaultEditor
{
    ...
    class TextEditorDisplayBindingWrapper : DefaultAbstractViewContent, IMementoCapable
        , IClipboardHandler, ITextEditorControlProvider, IUndoHandler
        , IEditable, IParseInformationListener, IPrintable, IPositionable, IToolsHost
    {
        #region AbstractViewControl
        /// <summary>
        /// Ovladač pohledu
        /// </summary>
        public override object Control { get => textEditorControl; }
        /// <summary>
        /// Uložení obsahu
        /// </summary>
        ...
        public override void Save(OpenedFile file, Stream stream)
        {
            ...
            if (!textEditorControl.CanSaveWithCurrentEncoding())
                if (MessageService.AskQuestion(GResources.GetResourceText(29450192) + ' ' + //RC 29450192 : Soubor nelze uložit s aktuálním kódování
                                               textEditorControl.Encoding.EncodingName + ' ' + GResources.GetResourceText(29450191) + //RC 29450191 : bez ztráty dat.
        ...
        /// </summary>
        public object ToolsControl { get { return EditorSideBar.Instance; } }
        #endregion

        /// <summary>
        /// textový ovladač
        /// </summary>
        internal ReportDesignerTextAreaControl textEditorControl;
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        protected virtual ReportDesignerTextAreaControl CreateRDTextAreaControl()
        {
        ...
        public override IViewContent Initialize(OpenedFile file)
        {
            ...
            TabPageText = GResources.GetResourceText(29450193); //RC 29450193 : Zdroj

            textEditorControl = CreateRDTextAreaControl();
