...
//    <Name>        Gordic.GFE.Parsers.RtfCompletionBinding.cs                  </Name>
//    <Description>    RTF doplnění kódu                                        </Description>
...
namespace Gordic.GFE.WinClient.Editor
{
    ...
    /// RTF doplnění kódu
    /// </summary>
    public class RtfCompletionBinding : AbstractNRefactoryResourceCodeCompletionBinding
    {
        /// <exclude/>
        protected override string Language { get { return "ALF-RTF"; } }
        /// <summary>
        ...
        public override bool HandleKeyPress(ICodeCompletionEditor editor, char ch)
        {
            ...
            if (editor is ReportDesignerTextAreaControl rdtac && Language.Equals(rdtac.Document.HighlightingStrategy.Name, StringComparison.InvariantCultureIgnoreCase))
            {
                ...
                {
                    RtfExpressionFinder ef = CreateExpressionFinder(rdtac.FileName);
        ...
        {
            RtfExpressionFinder ef = CreateExpressionFinder(editor.FileName);
        ...
        static RtfExpressionFinder CreateExpressionFinder(string fileName)
        {
            return new RtfExpressionFinder(ParserService.GetParseInformation(fileName));
        }
    }
}
