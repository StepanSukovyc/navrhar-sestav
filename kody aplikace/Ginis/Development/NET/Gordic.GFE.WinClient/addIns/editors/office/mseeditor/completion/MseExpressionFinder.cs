...
//    <Name>        Gordic.GFE.WinClient.MseExpressionFinder.cs                 </Name>
...
namespace Gordic.GFE.WinClient.Editor
{
    ...
    /// </summary>
    class MseExpressionFinder : ALFExpressionFinder
    {
        /// <summary>
        /// inicializace lexeru
        /// </summary>
        ...
        {
            lexer = ParserFactory.CreateLexer(SupportedLanguage.MSE, new StringReader(text));
        }

        /// <summary>
        /// prázdný konstruktor třídy
        /// </summary>
        public MseExpressionFinder()
            :base()
        {
        ...
        public MseExpressionFinder(ParseInformation parseInformation)
            : this()
        {
